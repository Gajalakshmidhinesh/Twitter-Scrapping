...
Original file is located at
    https://colab.research.google.com/drive/1syuCCqjZ6uQHEIFUMDiby8zuZe5h1ly0
"""
...
Tweet = pd.read_csv("Tweeter_scraping")  # Importing the converted Twetterscraping csv file
print(Tweet)
